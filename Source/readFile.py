...
if __name__ == "__main__":
    ...
    for root, subDirectories, files in os.walk(
            os.path.abspath("/home/kenjataimu/Desktop/CENG/CENG-9th_Semester/CEng499/Project/MLProject/Dataset")):
        for subDirectory in subDirectories:
            allFeatures.append(readGenreDirectory(
                "/home/kenjataimu/Desktop/CENG/CENG-9th_Semester/CEng499/Project/MLProject/Dataset/" + subDirectory))
